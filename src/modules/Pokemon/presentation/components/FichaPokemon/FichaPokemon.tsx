        ...
        <>
            ...
            <div className="bg-container/80 -mt-5 backdrop-blur-md rounded-t-2xl rounded-b-xl">
                ...
                <section className="grid sm:grid-cols-2 min-h-[250px] p-7 gap-12">
                    <div>
                        <h4 className="text-xl sm:text-2xl font-bold tracking-wide">Descripción</h4>
                        <DescripcionPokemon pokemon={pokemon} />
                    </div>
                    <div>
                        <h4 className="text-xl sm:text-2xl font-bold tracking-wide">Estadísticas</h4>
                ...
                <section className="flex flex-col p-7">
                    <h4 className="text-xl sm:text-2xl font-bold tracking-wide">Movimientos</h4>
